...
def _normalize_name(name):
    # type: (str) -> str
    """Make a name consistent regardless of source (environment1 or file)
    """
...
class Configuration(object):
    ...
    def load(self):
        # type: () -> None
        """Loads configuration from configuration files and environment1
        """
    ...
    def _load_config_files(self):
        ...
        if config_files[kinds.ENV][0:1] == [os.devnull]:
            logger.debug(
                ...
                "environment1's PIP_CONFIG_FILE being os.devnull"
            )
            return
    ...
    def _load_environment_vars(self):
        # type: () -> None
        """Loads configuration from environment1 variables
        """
    ...
    def _normalized_keys(self, section, items):
        ...
        regardless of source - configuration files or environment1.
        """
        normalized = {}
    ...
    def _iter_config_files(self):
        ...
        # environment1 variables have the lowest priority
