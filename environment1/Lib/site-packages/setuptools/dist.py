...
def _check_extra(extra, reqs):
    ...
    if marker and pkg_resources.invalid_marker(marker):
        raise DistutilsSetupError("Invalid environment1 marker: " + marker)
...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    def _finalize_requires(self):
        """
        Set `metadata.python_requires` and fix environment1 markers
    ...
    def _move_install_requirements_markers(self):
        """
        Move requirements in `install_requires` that are using environment1
    ...
    def _clean_req(self, req):
        """
        Given a Requirement, remove environment1 markers and return it.
        """
        req.marker = None
        return req
