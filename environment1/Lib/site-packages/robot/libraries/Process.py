...
class Process(object):
    ...
    | env        | Specifies environment1 variables given to the process. |
    | env:<name> | Overrides the named environment1 variable(s) only.     |
    ...
    environment1 variables. The ``env`` argument can be used to give the
    child a custom environment1 as a Python dictionary. If there is a need
    to specify only certain environment1 variable, it is possible to use the
